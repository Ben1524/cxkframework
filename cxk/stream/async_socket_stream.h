...
public:
    ...
    void setConnectCb(const connect_callback& cb){ m_connectCb = cb; }
    void setDisconnectCb(const disconnect_callback& cb){ m_disconnectCb = cb; }
...
protected:
    cxk::FiberSemaphore m_sem;
    cxk::FiberSemaphore m_waitSem;
    ...
    uint32_t m_sn;
    bool m_autoConnect;
    cxk::Timer::ptr m_timer;
    cxk::IOManager* m_iomanager;
...
public:
    ...
    connect_callback getConnectCb() const { return m_connectCb; }
    disconnect_callback getDisconnectCb() const { return m_disconnectCb; }
    void setConnectCb(const connect_callback& cb);
    void setDisconnectCb(const disconnect_callback& cb);
